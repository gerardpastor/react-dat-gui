...
function DatBoolean(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(DatRow_1.default, __assign({ label: label !== null && label !== void 0 ? label : path, className: (0, classnames_1.default)(['boolean', className]) }, rest, { children: (0, jsx_runtime_1.jsx)("input", { type: "checkbox", checked: value, onChange: handleChange }) })));
}
